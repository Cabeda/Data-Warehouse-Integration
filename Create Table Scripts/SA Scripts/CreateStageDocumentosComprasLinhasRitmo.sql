IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'DocumentosComprasLinhasRitmo')
	CREATE TABLE [dbo].[DocumentosComprasLinhasRitmo]
	(
...
ELSE
	TRUNCATE TABLE [dbo].[DocumentosComprasLinhasRitmo]
